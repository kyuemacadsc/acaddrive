 ...
 * https://www.youtube.com/watch?v=LG-kkuFHsqg&list=PLfX43FZVe8PkxBMkzJovwXK71BJncw0KU&index=77&ab_channel=CodexWorld
 */
class Pagination{
    protected $baseURL        = '';
    protected $totalRows      = '';
    ...
    function createLinks(){ 
        ...
        if ($numPages == 1){
            if ($this->showCount){
                $info = '<p class="invisible">Showing : ' . $this->totalRows . '</p>';
                return $info;
            }else{
                return '';
            }
